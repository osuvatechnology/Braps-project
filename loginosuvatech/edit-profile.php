                     ...
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   <tr>
                                    <th>First Name</th>
                                       <td><input class="form-control" id="fname" name="fname" type="text" value="Sandy
                                       <?php
                                    //    php echo $result['fname'];
                                       ?>
                                       " required /></td>
                                   ...
                                   <tr>
                                       <th>Last Name</th>
                                       <td><input class="form-control" id="lname" name="lname" type="text" value="Sam
                                    ...
                                    //    php echo $result['lname'];
                                       ?>
                                         ...
                                         <tr>
                                       <th>Contact No.</th>
                                       <td colspan="3"><input class="form-control" id="contact" name="contact" type="text" value="9885381998
                                       <?php
                                        // echo $result['contactno'];
                                       ?>
                                       "
                                        pattern="[0-9]{10}"
                                         title="10 numeric characters only"  maxlength="11" 

                                       required /></td>
                                   </tr>
                                   <tr>
                                       <th>Email</th>
                                       <td colspan="3">sandysan@gmail.com
