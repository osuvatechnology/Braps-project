...
?>
                              ...
                              B/w Dates Report Result from <?php
...
//                               {
                            ...
                            //    echo $cnt;
                               ?></td>
                                ...
                                //    echo $row['lname'];
                                   ?></td>
                                  <td>sandysam@gmail.com<?php 
                                //   echo $row['email'];
                                  ?></td>
                                  <td>9885381998<?php 
                                //   echo $row['contactno'];
                                  ?></td>  <td>Posted Date<?php
                                //    echo $row['posting_date'];
                                   ?></td>
                                  <td>
                                     
                                     <a href="user-profile.php?uid=<?php
                                    //   echo $row['id'];
                                      ?>"> 
                          <i class="fas fa-edit"></i></a>
                                     <a href="manage-users.php?id=<?php
                                    //   echo $row['id'];
                                      ?>" onClick="return confirm('Do you really want to delete');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                  </td>
                              </tr>
                              <?php
                            //    $cnt=$cnt+1; }
